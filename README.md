...
There are a few more configurable values included in the program, but the current study's setup created a 5 × 3 × 3 × 3 × 3 × 3 = **1,215 parameter matrix** where each cell represented a unique combination of parameters. The simulations were run for 1,000 iterations per cell, resulting in a total of **1,215,000 simulations**. To review the code and get a detailed breakdown along with instructions on how to run the process, see the program's [README](srcR/run_power_analysis/README.md).
